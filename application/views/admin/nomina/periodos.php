...
<?php if ( $this->session->userdata('root') |  $this->session->userdata('admin')): ?>
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-4">
            <h2>Seleccione Periodo</h2>
            <select class="form-control " id="periodo" name="periodo" onchange="serach_periodos(value);">
                <option value="" selected disabled hidden > Periodo</option>
