			...
			<form role="form" id="form_crear_empleado">
				...
				<div class="row">	
						...
						<div class=" col-sm-6 col-md-6">							
								...
								<input type="text" name="ap_paterno" id="ap_paterno" class="form-control " tabindex="5">								
						</div>
						<div class=" col-sm-6 col-md-6">							
								<label for="ape_materno">Apellido Materno</label>
								<input type="text" name="ap_materno" id="ap_materno" class="form-control" tabindex="6">								
						</div>
						<div class=" col-sm-6 col-md-6">							
								<label for="fecha_nacimiento">Fecha de Nacimiento</label>
								<input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" tabindex="7">													
						</div>
						<div class=" col-sm-6 col-md-6">						
								<label for="fecha_ingreso">Fecha de Ingreso</label>
								<input type="date" name="fecha_ingreso" id="fecha_ingreso" class="form-control " tabindex="8">								
						</div>
						<div class=" col-sm-6 col-md-6">							
								<label for="curp">CURP</label>
								<input type="text" onblur="validarInput(this)" name="curp" id="curp" class="form-control" tabindex="9" >											
						</div>
						<div class=" col-sm-6 col-md-6">						
								<label for="rfc">RFC</label>
								<input type="text" name="rfc" onblur="ValidaRfc(this.value)" id="rfc" class="form-control " tabindex="10">
						</div>
						<div class=" col-sm-6 col-md-6 ">						
								<label for="no_empleado">Num. Empleado</label>
		                        <input type="text" name="no_empleado" id="no_empleado" class="form-control" tabindex="11">							
						</div>
						<div class=" col-sm-6 col-md-6">						
								<label for="depto">Departamento</label>
								<select class="form-control " id="depto" name="id_depto" tabindex="12">
						...
						<div class=" col-sm-6 col-md-6">
								...
								<select class="form-control " id="puesto" name="id_puesto" tabindex="13">
						...
						<div class=" col-sm-6 col-md-6">							
								...
								<select class="form-control " id="tipo_trabajador" name="id_tipo_trabajador" tabindex="14">
