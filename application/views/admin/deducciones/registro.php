		...
		<form role="form" id="formDeduciones">
			...
			<div class="row">
				<div class="col-xs-12 col-md-4">
					<button id="ladda_btn_saveDeduccion" type="submit" value="Registrar" class="ladda-button btn btn-primary btn-block btn-lg" data-style="expand-left" tabindex="4" onclick="saveDeduccion()" ><span class="fa fa-save"></span> Registrar</button>
				</div>
			</div>
		</form>
	</div>
