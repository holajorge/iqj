...
function leer(){
	...
	$xml        = new SimpleXMLElement ("../../timbrados/ejemplo_cfdi33_nomina12.xml",0,true);
	$namespaces = $xml->getDocNamespaces($xml);
	...
	foreach ($xml->xpath('//cfdi:Comprobante') as $Emisor){  // SECCION EMISOR
	   
	   echo $emisor_rfc   = $Emisor['Certificado'];	   
